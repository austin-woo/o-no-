...
public class SudokuGridPanel extends JPanel implements Scrollable,
     ...
     * empty.
     * @param map - corresponding DisplayMap
     * @param res - corresponding ResourceBundle
     */
    public SudokuGridPanel(DisplayMap map, ResourceBundle res) {
        displayMap = map;
        resources = res;
    ...
    private String getToolTipText(Location loc) {
        ...
        if (f != null)
            return MessageFormat.format(resources
                    .getString("cell.tooltip.nonempty"), new Object[] { loc, f });
        else
            return MessageFormat.format(resources
                    .getString("cell.tooltip.empty"), new Object[] { loc, f });
    }
     ...
     * parameter minSize.
     * @param minSize - minimum size of cell
     */
    ...
    /**
     * Scrollable method implemented by GridWorld creators.
     * @param visibleRect - Rectangle that is visible
     * @param orientation - used integer to represent orientation
     * @param direction - used integer to represent direction 
     * @return int value cellSize + 1
     */
     ...
     * @param orientation - used integer to represent orientation
     * @param direction - used integer to represent direction 
     * @return int increment of scroll block
     */
     ...
     * Scrollable method implemented by GridWorld creators.
     * 
     * @return boolean based on on scrollable track w/in width
     */
    ...
    /**
     * Scrollable method implemented by GridWorld creators.
     * @return boolean based on scrollable track w/in height
     */
    ...
    /**
     * Scrollable method implemented by GridWorld creators.
     * @return Dimension of preffered scrollable viewport size
     */
    ...
    /**
     * Another method implemented by GridWorld creators.
     * @param hDelta - int height change
     * @param vDelta - int width change
     */
